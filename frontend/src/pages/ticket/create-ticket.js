...
const CreateTicket = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if(e.target.id === 'ticketName')
      ...
      ticketDataTemp.spritnId = e.target.value;
    ...
    <div className='ticketPage'>
        ...
        <div className="ticketCard" id="ticketFormWrap">    
          ...
          <form onSubmit={validateTicket} id="ticketForm">
            ...
            <select value={ticketData.projectId} className="TicketInput" id='ticketProject' name="ticketProject" onChange={handleInputChange}>
              <option value="">Select Option</option>
