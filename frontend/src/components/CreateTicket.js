    ...
    <div className='ticketPage'>
        ...
        <div className="ticketCard" id="ticketFormWrap">    
          ...
          <form onSubmit={validateTicket} id="ticketForm">
            ...
            <select value={ticketData.spritnId ? ticketData.spritnId : ""} className="loginInput form-control" id='ticketSprint' name="ticketSprint" onChange={handleInputChange}>
              <option value="">Select Option</option>
            ...
            <select value={ticketData.state ? ticketData.state : ""} className="loginInput form-control" id='ticketState' name="ticketState" onChange={handleInputChange}>
              <option value="">Select Option</option>
